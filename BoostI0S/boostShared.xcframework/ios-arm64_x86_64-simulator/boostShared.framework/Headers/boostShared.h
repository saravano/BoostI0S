...
@property (readonly) NSString *geoCodeUrl __attribute__((swift_name("geoCodeUrl")));
@property (readonly) NSString *googleKey __attribute__((swift_name("googleKey")));
@property (readonly) NSString *pxKey __attribute__((swift_name("pxKey")));
@property (readonly) NSString *pxUrl __attribute__((swift_name("pxUrl")));
@property (readonly) NSString *sendGridKey __attribute__((swift_name("sendGridKey")));
@property (readonly) NSString *sendGridUrl __attribute__((swift_name("sendGridUrl")));
@end
